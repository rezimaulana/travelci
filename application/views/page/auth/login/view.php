...
<body>
    <center>
        <div class="wrapper">
            ...
            <form method="POST" action="<?= base_url('auth/proses_login') ?>" class="form-signin" id="form_login">
                <h1 class="clr-white"> Login Pelanggan </h1>
        
                <div class="form-group mx-auto text-center">
                    <a href="<?= base_url('login-direktur') ?>" class="btn btn-primary">Login direktur</a>
                    <a href="<?= base_url('login-keuangan') ?>" class="btn btn-primary">Login keuangan</a>
                    <a href="<?= base_url('login-tour') ?>" class="btn btn-primary" id="login-tour">Login tour</a>
                    <br>
                </div>
                ...
                <p align="right"><a href="<?= base_url('registrasi') ?>" class="clr-white">Belum Punya Akun ?</a></p>
